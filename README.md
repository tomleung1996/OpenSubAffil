...
Reference implementation for the paper *OpenSubAffil: A large-scale dataset of sub-institutional name disambiguation and hierarchical structures from OpenAlex*. The released dataset is available at Zenodo: [https://doi.org/10.5281/zenodo.19602782](https://doi.org/10.5281/zenodo.19602782).
